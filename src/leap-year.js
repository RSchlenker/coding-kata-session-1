...
const notIsDivisibleBy100 = R.complement(isDivisibleBy(R.__, 100))
const isDivisibleBy4AndNot100 = R.both(isDivisibleBy(R.__, 4), notIsDivisibleBy100)
export const isLeapYear = R.either(isDivisibleBy4AndNot100, isDivisibleBy400)
